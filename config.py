...
class Config(object):
    ...
    def __init__(self):
        ...
        self.dataset_name = "cpm15" # extracts dataset info from dataset.py
        ...
        # 要根据实际情况改！！
        self.train_dir_list = [
            "extracted_dataset/cpm15/2024_05_25--12_39_15/train/540x540_164x164"
        ]
        self.valid_dir_list = [
            "extracted_dataset/cpm15/2024_05_25--12_39_15/valid/540x540_164x164"
        ]
        ...
        module = importlib.import_module(
            f"models.{model_name}.opt"  # model_name: 'hovernet'
        )  # module = <module 'models.hovernet.opt' from 'G:\\hovernet\\models\\hovernet\\opt.py'>

        self.model_config = module.get_config(nr_type, model_mode)  # nr_type = 5, model_mode = 'original'
